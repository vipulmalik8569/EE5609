...
\begin{align}
 \vec{p}=\left(\frac{\vec{u}\cdot\vec{v}}{{\norm{\vec{v}}}^2}\right) \vec{v}   
\end{align}
...
\begin{align}
 \vec{p}=\left[\frac{\myvec{1 \\ 3 \\ 7}\cdot\myvec{7 \\ -1 \\ 8}}{{\norm{\begin{matrix}7 \\ -1 \\ 8\end{matrix}}}^2}\right] \myvec{7 \\ -1 \\ 8}   
\end{align}
\begin{align}
\vec{p}=0.52 \myvec{7 \\ -1 \\ 8}= \myvec{3.68 \\ -0.52 \\ 4.21}
\end{align}

\centering Hence the projection of $\vec{u}$ on $\vec{v}$ is $$\vec{p}=\myvec{3.68 \\ -0.52 \\ 4.21}$$
